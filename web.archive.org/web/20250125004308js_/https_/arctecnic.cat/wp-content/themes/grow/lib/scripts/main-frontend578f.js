...
jQuery(document).ready(function() {
	...
	/* Supported Platforms */
	var all_videos = jQuery( 'iframe[src*="//web.archive.org/web/20250125004308/https://player.vimeo.com"], iframe[src*="//web.archive.org/web/20250125004308/https://www.youtube.com"], iframe[src*="//web.archive.org/web/20250125004308/https://blip.tv"], iframe[src*="//web.archive.org/web/20250125004308/https://www.slideshare.net"], iframe[src*="//web.archive.org/web/20250125004308/https://www.scribd.com"], iframe[src*="//web.archive.org/web/20250125004308/https://revision3.com"], iframe[src*="//web.archive.org/web/20250125004308/https://www.hulu.com"], iframe[src*="//web.archive.org/web/20250125004308/https://www.funnyordie.com"], iframe[src*="//web.archive.org/web/20250125004308/https://www.dailymotion.com"], iframe[src*="//web.archive.org/web/20250125004308/https://maps.google.com"], embed[src*="//web.archive.org/web/20250125004308/https://v.wordpress.com"], object, embed' );
...
jQuery(document).ready(function() {
	...
	/* Supported Platforms */
	var all_sounds = jQuery( 'iframe[src^="https://web.archive.org/web/20250125004308/http://w.soundcloud.com"]' );
...
/*
     ...
     INTERNET ARCHIVE ON 10:07:18 Sep 26, 2025.
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 23.37
  LoadShardBlock: 188.078 (3)
  PetaboxLoader3.datanode: 225.369 (4)
  load_resource: 51.022
*/