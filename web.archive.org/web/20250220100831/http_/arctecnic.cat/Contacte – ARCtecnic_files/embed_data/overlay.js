...
f.bindTo("center",g,"projectionCenterQ");f.bindTo("projection",b);f.bindTo("projectionTopLeft",g);f=d.lr=d.lr||new Es(f);f.bindTo("zoom",g);f.bindTo("offset",g);f.bindTo("projection",b);f.bindTo("projectionTopLeft",g);a.bindTo("projection",f,"outProjection");a.bindTo("panes",g);d.Wa=[_.E.addListener(a,"panes_changed",c),_.E.addListener(g,"zoom_changed",c),_.E.addListener(g,"offset_changed",c),_.E.addListener(b,"projection_changed",c),_.E.addListener(g,"projectioncenterq_changed",c)];c();b instanceof
...
b,c){this.map=a;this.h=b;this.l=c;this.j=!1;_.eg(this.map,"Ox");c.pf(this)},Xka=function(a,b){a.h.get("projection")!=b&&(a.h.bindTo("panes",a.map.__gm),a.h.set("projection",b))},Gs=function(a,b){this.m=a;this.l=b;this.h=null;this.j=[]};_.B(Es,_.F);Es.prototype.changed=function(a){"outProjection"!=a&&(a=!!(this.get("offset")&&this.get("projectionTopLeft")&&this.get("projection")&&_.Yd(this.get("zoom"))),a==!this.get("outProjection")&&this.set("outProjection",a?this.h:null))};var Hs={};_.B(Rka,_.F);Hs.pf=function(a){if(a){var b=a.getMap();(Fs(a).Pq||null)!==b&&(b&&Ska(a,b),Fs(a).Pq=b)}};Hs.Mf=function(a){var b=Fs(a),c=b.Va;c&&c.unbindAll();(c=b.lr)&&c.unbindAll();a.unbindAll();a.set("panes",null);a.set("projection",null);b.Wa&&_.bb(b.Wa,_.E.removeListener);b.Wa=null;b.Wl&&(b.Wl.Ka.Gd(),b.Wl=null);delete Fs(a).Pq};var Is={};Uka.prototype.draw=function(){this.j||(this.j=!0,this.h.onAdd&&this.h.onAdd());this.h.draw&&this.h.draw()};Gs.prototype.dispose=function(){};Gs.prototype.yc=function(a,b,c,d,e,f,g,h){var k=this.h=this.h||new _.gn(this.m,this.l,function(){});k.yc(a,b,c,d,e,f,g,h);a=_.y(this.j);for(b=a.next();!b.done;b=a.next())b=b.value,Xka(b,k),b.draw()};Gs.prototype.pf=function(a){this.j.push(a);this.h&&Xka(a,this.h);this.l.refresh()};Gs.prototype.Mf=function(a){_.mb(this.j,a)};Is.pf=Wka;Is.Mf=Vka;_.Qe("overlay",{Wo:function(a){if(a){(0,Hs.Mf)(a);(0,Is.Mf)(a);var b=a.getMap();b&&(b instanceof _.gf?(0,Is.pf)(a):(0,Hs.pf)(a))}},preventMapHitsFrom:function(a){_.Ln(a,{onClick:function(b){return _.qn(b.event)},rd:function(b){return _.nn(b)},ph:function(b){return _.on(b)},Sd:function(b){return _.on(b)},Ad:function(b){return _.pn(b)}}).mi(!0)},preventMapHitsAndGesturesFrom:function(a){a.addEventListener("click",_.We);a.addEventListener("contextmenu",_.We);a.addEventListener("dblclick",_.We);a.addEventListener("mousedown",
...
/*
     FILE ARCHIVED ON 19:59:49 Feb 19, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:30:44 Sep 26, 2025.
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 96.28
  LoadShardBlock: 211.848 (3)
  PetaboxLoader3.datanode: 414.854 (5)
  load_resource: 3789.415 (2)
  PetaboxLoader3.resolve: 3546.808 (2)
*/